...
public class HdaAssistantTool : EditorWindow
{
    ...
    private void OnGUI_Left_FunctionButtonGroup()
    {
        ...
        if (_houdiniAssetRootEditor)
        {
            ...
            EditorGUILayout.LabelField("Bake Path:", new GUIStyle(GUI.skin.label) {alignment = TextAnchor.MiddleLeft},
    ...
    private void OnGUI_Right_HDAInspector()
    {
        ...
        else
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            var e = Event.current;
            var dropArea = GUILayoutUtility.GetRect(0, 0, GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
